...
<html lang="pt-BR">
    ...
    <body style="font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 20px;">
        <div style="max-width: 600px; margin: 0 auto; background-color: white; padding: 30px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            ...
            <p>Viemos informar que sua venda do dia {{ $sale->made_at }} no valor de R${{ $sale->amount }} e com comissão de R${{ $sale->commission }}, acabou de ser cadastrada pelo administrador {{ $user->name }}!</p>
